(function(t, e) {
  var s = e.body,
    ...
    x = {
      goTop: function(e) {
        ...
        i && i > e ? (t.scrollTo(0, Math.max(i - s, 0)), v(arguments.callee.bind(this, e, s))) : e && i < e ? (t.scrollTo(0, Math.min(i + s, e)), v(arguments.callee.bind(this, e, s))) : this.toc.actived(e)
      },
      ...
      toggleMenu: function(e) {
        ...
        if (e) {
          if (l.classList.remove("hide"), t.innerWidth < 1241)
            if (d.classList.add("in"), l.classList.add("show"), p) {
              var s = $();
      ...
      toc: function() {
        ...
        return t.querySelector('a[href="#' + n[0].id + '"]').parentNode.classList.add("active"), {
          ...
          actived: function(e) {
            ...
            e < w(n[0]).y && (t.querySelector("li.active").classList.remove("active"), t.querySelector('a[href="#' + n[0].id + '"]').parentNode.classList.add("active"))
          }
        }
      }(),
      hideOnMask: [],
  ...
  }, !1), t.BLOG.SHARE && x.share(), t.BLOG.REWARD && x.reward(), x.noop = y, x.even = L, x.$ = a, x.$$ = n, Object.keys(x).reduce(function(t, e) {
    return t[e] = x[e], t
